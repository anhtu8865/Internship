    ...
    return (
      ...
      <div className="max-w-xl px-8 py-8 border-0 shadow-lg rounded-xl h-auto bg-white mx-auto">
        ...
        <div className="px-6">
          ...
          <FormInput r={register} name="rolename" label='Role Name' required />
          <FormInput r={register} name="roledescription" label='Description'  /> 
          <div className="w-full mt-10 mb-5 px-10">
            <input type="submit" value="Create Role" className="bg-green-600 rounded-md py-2 
